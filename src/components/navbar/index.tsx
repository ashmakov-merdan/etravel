...
const Navbar = () => {
  ...
  return (
    <motion.div className="px-4 py-6 2xl:p-0 container mx-auto fixed top-0 left-0 right-0 grid max-lg:grid-cols-2 grid-cols-3 items-center bg-transparent" style={{ zIndex }}>
