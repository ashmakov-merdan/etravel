...
const Destinations: FC = () => {
  ...
  return (
    <section id={"destinations"} className="pt-28 container mx-auto h-full space-y-10">
      <h2 className="text-center text-5xl text-primary font-bold">Explore top places</h2>
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5">{renderDestinations}</div>
    </section>
  )
};
