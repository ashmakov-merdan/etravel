  ...
  return (
    <section id="contact-us" className="pt-24 px-4 2xl:px-0 container mx-auto">
      <div className="relative grid grid-cols-1 lg:grid-cols-2 rounded-[100px] overflow-hidden">
        ...
        <div className="relative px-14 py-10 lg:px-20 bg-primary-100">
          <div className="space-y-5 lg:space-y-8">
            <h2 className="text-xl sm:text-2xl md:text-3xl xl:text-5xl font-bold text-primary">{t('heading')}</h2>
